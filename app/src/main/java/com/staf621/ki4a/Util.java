...
public class Util {
    ...
    public static String ip_domian_string = "";
    ...
    protected static boolean isOnline(Context context)
    {
        ...
        /*boolean result = ( ContextCompat.checkSelfPermission( context, Manifest.permission.INTERNET )
                == PackageManager.PERMISSION_GRANTED );
        String ips = getIPAddress(true);*/
        ...
        if (netInfo != null && netInfo.isConnected()) {
            try {
                ...
                urlc.connect(); // TODO Fix the IOException thrown in Android 8
    ...
    public static boolean isIp4Address(String ipAddress) {
        Pattern pattern = Pattern.compile(Util.IPADDRESS_PATTERN);
